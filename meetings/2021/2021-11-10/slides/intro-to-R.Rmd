...
output:
  xaringan::moon_reader:
    css: ['default', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', './assets/all.css', './assets/slides.css']
    lib_dir: libs
    nature:
...
background-image: url('assets/mika-baumeister-J5yoGZLdpSI-unsplash.jpg')
...
.center[
```{r echo = FALSE}
knitr::include_graphics("./assets/rstudio-cloud.png")
```
]
...
By the end of this series of sessions you will
...
We'll talk more about **loops** and **iteration** later on
...
knitr::include_graphics("./assets/recycling.png")
```
]
